...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    COLON = 7,                     // COLON
    GREATER = 8,                   // GREATER
    GREATER_EQUAL = 9,             // GREATER_EQUAL
    LESS = 10,                     // LESS
    LESS_EQUAL = 11,               // LESS_EQUAL
    EQUAL_TO = 12,                 // EQUAL_TO
    NOT_EQUAL_TO = 13,             // NOT_EQUAL_TO
    PLUS = 14,                     // PLUS
    MINUS = 15,                    // MINUS
    TIMES = 16,                    // TIMES
    DIVIDE = 17,                   // DIVIDE
    MODULO = 18,                   // MODULO
    POWER = 19,                    // POWER
    OPEN_PAREN = 20,               // OPEN_PAREN
    CLOSE_PAREN = 21,              // CLOSE_PAREN
    OPEN_BRACE = 22,               // OPEN_BRACE
    CLOSE_BRACE = 23,              // CLOSE_BRACE
    OPEN_BRACKET = 24,             // OPEN_BRACKET
    CLOSE_BRACKET = 25             // CLOSE_BRACKET
      };
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_QUESTION = 5,                          // QUESTION
        S_COMMA = 6,                             // COMMA
        S_COLON = 7,                             // COLON
        S_GREATER = 8,                           // GREATER
        S_GREATER_EQUAL = 9,                     // GREATER_EQUAL
        S_LESS = 10,                             // LESS
        S_LESS_EQUAL = 11,                       // LESS_EQUAL
        S_EQUAL_TO = 12,                         // EQUAL_TO
        S_NOT_EQUAL_TO = 13,                     // NOT_EQUAL_TO
        S_PLUS = 14,                             // PLUS
        S_MINUS = 15,                            // MINUS
        S_TIMES = 16,                            // TIMES
        S_DIVIDE = 17,                           // DIVIDE
        S_MODULO = 18,                           // MODULO
        S_POWER = 19,                            // POWER
        S_OPEN_PAREN = 20,                       // OPEN_PAREN
        S_CLOSE_PAREN = 21,                      // CLOSE_PAREN
        S_OPEN_BRACE = 22,                       // OPEN_BRACE
        S_CLOSE_BRACE = 23,                      // CLOSE_BRACE
        S_OPEN_BRACKET = 24,                     // OPEN_BRACKET
        S_CLOSE_BRACKET = 25,                    // CLOSE_BRACKET
        S_YYACCEPT = 26,                         // $accept
        S_27_expr_result = 27,                   // expr.result
        S_expr = 28,                             // expr
...
switch (yykind)
    ...
    struct symbol_type : basic_symbol<by_kind>
    {
      ...
      {
#if !defined _MSC_VER || defined __clang__
        YY_ASSERT ((token::IDENTIFIER <= tok && tok <= token::CLOSE_BRACKET));
#endif
      }
    };

    /// Build a parser object.
    parser (ExprCompiler& drv_yyarg);
    virtual ~parser ();
    ...
    // Implementation of make_symbol for each token kind.
      ...
      {
        return symbol_type (token::QUESTION, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::QUESTION, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::GREATER_EQUAL, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::GREATER_EQUAL, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      {
        return symbol_type (token::LESS_EQUAL, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::LESS_EQUAL, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_EQUAL_TO (std::string v, location_type l)
      {
        return symbol_type (token::EQUAL_TO, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_EQUAL_TO (const std::string& v, const location_type& l)
      {
        return symbol_type (token::EQUAL_TO, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_NOT_EQUAL_TO (std::string v, location_type l)
      {
        return symbol_type (token::NOT_EQUAL_TO, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_NOT_EQUAL_TO (const std::string& v, const location_type& l)
      {
        return symbol_type (token::NOT_EQUAL_TO, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      ...
      static
      symbol_type
      make_OPEN_PAREN (std::string v, location_type l)
      {
        return symbol_type (token::OPEN_PAREN, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_OPEN_PAREN (const std::string& v, const location_type& l)
      {
        return symbol_type (token::OPEN_PAREN, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CLOSE_PAREN (std::string v, location_type l)
      {
        return symbol_type (token::CLOSE_PAREN, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_CLOSE_PAREN (const std::string& v, const location_type& l)
      {
        return symbol_type (token::CLOSE_PAREN, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_OPEN_BRACE (std::string v, location_type l)
      {
      ...
      static
      symbol_type
      make_OPEN_BRACE (const std::string& v, const location_type& l)
      {
      ...
      static
      symbol_type
      make_CLOSE_BRACE (std::string v, location_type l)
      {
        return symbol_type (token::CLOSE_BRACE, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_CLOSE_BRACE (const std::string& v, const location_type& l)
      {
        return symbol_type (token::CLOSE_BRACE, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_OPEN_BRACKET (std::string v, location_type l)
      {
        return symbol_type (token::OPEN_BRACKET, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_OPEN_BRACKET (const std::string& v, const location_type& l)
      {
        return symbol_type (token::OPEN_BRACKET, v, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_CLOSE_BRACKET (std::string v, location_type l)
      {
        return symbol_type (token::CLOSE_BRACKET, std::move (v), std::move (l));
      }
#else
      static
      symbol_type
      make_CLOSE_BRACKET (const std::string& v, const location_type& l)
      {
        return symbol_type (token::CLOSE_BRACKET, v, l);
      }
#endif
